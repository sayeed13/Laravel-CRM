        ...
        <div class="col-md-4 col-sm-6 col-lg-4 col-xl-3">
            <div class="card dash-widget">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <h3><a href="{{route('attendance.report.break')}}">In Breaks</a></h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="table-responsive">
                <table class="table table-striped custom-table mb-0" id="attendance-table">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Name</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $('#attendance-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('api.attendReport.manager') }}",
                data: function (data) {
