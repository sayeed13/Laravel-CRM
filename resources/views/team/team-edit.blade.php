                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="team_name" value="{{ $team->team_name }}">
                        </div>
                        @error('team_name')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="desc" value="{{ $team->desc }}">
                        </div>
                        @error('desc')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select name="tleader_id" class="select">
                                ...
                                @foreach ($team_leaders as $team_leader)
                                    <option {{ $team_leader->id == $team->tleader_id ? 'selected="selected"' : '' }} value="{{$team_leader->id}}">{{$team_leader->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="tmanager_id" class="select">
                                ...
                                @foreach ($managers as $manager)
                                    <option {{ $manager->id == $team->tmanager_id ? 'selected="selected"' : '' }} value="{{$manager->id}}">{{$manager->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
