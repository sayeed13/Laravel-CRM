<x-admin-layout>
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('support-teams.index') }}">Support Team</a></li>
                        <li class="breadcrumb-item active">Add</li>
                    </ul>
                </div>
                <div class="col-auto float-right ml-auto">
                    <a href="{{ route('support-teams.index') }}" class="btn add-btn"><i class="fa fa-arrow-left"></i> Back to List</a>
                </div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="modal-content">
        <div class="modal-body">
            <form action="{{route('support-teams.store')}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
